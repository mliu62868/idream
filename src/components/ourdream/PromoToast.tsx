  ...
  return (
    <aside className="fixed bottom-6 right-6 z-30 hidden w-[300px] rounded-[20px] bg-[rgb(46,46,46)] p-3 shadow-[2px_2px_8px_3px_rgba(0,0,0,0.25)] md:block">
      <div className="relative h-[178px] overflow-hidden rounded-[14px]">
        ...
        />
        <button className="absolute right-2 top-2 flex h-5 w-5 items-center justify-center rounded-full bg-black/35 text-white">
          <X className="h-3 w-3" />
        </button>
      </div>
      <div className="px-1 pb-1 pt-3">
        ...
        <button className="mt-4 flex h-9 w-full items-center justify-center gap-2 rounded-full bg-white text-[12px] font-bold leading-4 text-[rgb(13,13,13)]">
          Join Now
