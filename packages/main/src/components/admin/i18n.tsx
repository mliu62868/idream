...
const zh: Record<string, string> = {
  ...
  "Engineering-only model diagnostics. Operators use seeded profiles in Profiles & Rollout.": "仅用于工程诊断。运营在 Profiles & Rollout 中使用已 seed 的内置配置。",
  ...
  "Official characters": "官方角色",
  "Open Profiles & Rollout": "打开 Profiles & Rollout",
  "Open jobs": "打开任务",
  "Path": "路径",
  "Optional": "可选",
