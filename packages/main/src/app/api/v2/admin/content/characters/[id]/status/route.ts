import { setCharacterStatus } from "@/server/modules/admin-v2/content/merchandising";
...
export async function POST(request: Request, context: Context) {
  ...
  return adminV2Route(request, () =>
    executeAdminMutation<Body>(
      "POST /api/v2/admin/content/characters/:id/status",
      request,
      {
        params: { id },
        ...
        mutate: (tx, { actor, body, requestId }) =>
          setCharacterStatus({ tx, request, actor, requestId, id, body }),
