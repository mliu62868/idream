...
} from "../shared/media-asset-authority-dependencies";
import {
...
export async function patchContentAsset(input: {
  request: Request;
  id: string;
  actor: AdminActor;
...
export async function preflightContentAssetArchive(
...
export async function bulkPatchContentAssets(input: {
  request: Request;
  actor: AdminActor;
