...
describe("Admin v2 architecture boundaries", () => {
  ...
  it("keeps overview and generic saved-view authorities out of the dispatcher", async () => {
    ...
    // Analytics overview left for admin-v2; abuseOverview / providerOps still live here and
    // belong to other domains, so this file is emptied one function at a time, never reordered.
