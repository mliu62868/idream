...
const EnvSchema = z.object({
  ...
  ACCOUNT_MAIL_PROVIDER: z.enum(["disabled", "resend"]).default("disabled"),
  ACCOUNT_MAIL_FROM: z.string().email().optional(),
  ...
  POCKET_TTS_DEFAULT_VOICE_ID: z.string().min(1).default("anna"),
