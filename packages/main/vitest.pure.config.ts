...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "prisma/release-manifest-contract-parity.test.ts",
      ...
      "src/server/modules/admin-v2/metrics/certification.test.ts",
      "src/server/modules/admin-v2/metrics/engine.test.ts",
      ...
      "src/server/readiness/comfyui-endpoint-authority.test.ts",
      ...
      "src/server/modules/chat/turn-scope.test.ts",
    ],
  },
  resolve: {
    alias: [
