...
export const ADMIN_V2_API_OPERATIONS = [
  ...
  operation("POST", "/api/v2/admin/cases/:id/actions", allOf("case.decide"), "customerCaseActionRequestSchema", "operationsCaseSchema"),
  operation("POST", "/api/v2/admin/cases/:id/assignment", allOf("case.assign"), "caseAssignmentRequestSchema", "operationsCaseSchema"),
  ...
  operation("POST", "/api/v2/admin/cases/:id/commands/reopen", allOf("case.decide"), "caseReopenRequestSchema", "operationsCaseSchema"),
  operation("POST", "/api/v2/admin/cases/:id/commands/wait", allOf("case.assign"), "caseWaitRequestSchema", "operationsCaseSchema"),
  operation("POST", "/api/v2/admin/cases/:id/decisions", allOf("case.decide"), "caseDecisionRequestSchema", "operationsCaseSchema"),
  operation("POST", "/api/v2/admin/cases/:id/verification", allOf("case.decide"), "caseVerificationRequestSchema", "operationsCaseSchema"),
  ...
  operation("POST", "/api/v2/admin/characters/performance/backfill", allOf("analytics.metric.export"), "characterPerformanceBackfillRequestSchema", "characterPerformanceBackfillResultSchema"),
  ...
  operation("POST", "/api/v2/admin/characters/route-qualifications/commands/evaluate", allOf("content.production.write"), "generationRouteQualificationEvaluateRequestSchema", "generationRouteQualificationSchema"),
  ...
  operation("POST", "/api/v2/admin/characters/:id/portfolio-decisions", allOf("character.project.write"), "characterPortfolioDecisionRequestSchema", "characterPortfolioDecisionSchema"),
  ...
  operation("POST", "/api/v2/admin/characters/:id/releases", allOf("character.release.propose"), "characterReleaseProposeRequestSchema", "characterReleaseSchema"),
  ...
  operation("GET", "/api/v2/admin/collaboration/:targetType/:targetId/activity", oneOfBy("collaboration_target_read", ...collaborationRead), "collaborationQuerySchema", "collaborationActivityListSchema"),
  ...
  operation("PUT", "/api/v2/admin/collaboration/:targetType/:targetId/watch", oneOfBy("collaboration_target_read", ...collaborationRead), "collaborationWatchSchema+idempotency-key", "collaborationWatchResultSchema"),
  operation("GET", "/api/v2/admin/collaboration/mentions", allOf("dashboard.read"), "collaborationQuerySchema", "collaborationActivityListSchema", collaborationRead),
  ...
  operation("GET", "/api/v2/admin/experiments/:id/analysis", allOf("experiment.manage"), "experimentAnalysisQuerySchema", "experimentAnalysisSchema"),
  ...
  operation("POST", "/api/v2/admin/generation/requests/:id/commands/cancel", allOf("generation.job.requeue"), "generationRequestCancelSchema", "generationRequestCancelResultSchema"),
  ...
  operation("PATCH", "/api/v2/admin/incidents/:id", allOf("ops.incident.manage"), "incidentTriageRequestSchema", "incidentDetailSchema"),
  operation("POST", "/api/v2/admin/incidents/:id/action-plans/preview", allOf("ops.incident.manage"), "incidentActionPlanPreviewRequestSchema", "incidentActionPlanSchema"),
  ...
  operation("POST", "/api/v2/admin/incidents/:id/commands/close", allOf("ops.incident.manage"), "incidentCloseRequestSchema", "incidentDetailSchema"),
  operation("POST", "/api/v2/admin/incidents/:id/commands/merge", allOf("ops.incident.manage"), "incidentMergeRequestSchema", "incidentDetailSchema"),
  ...
  operation("POST", "/api/v2/admin/incidents/:id/commands/split", allOf("ops.incident.manage"), "incidentSplitRequestSchema", "incidentDetailSchema"),
  operation("POST", "/api/v2/admin/incidents/:id/verification", allOf("ops.incident.manage"), "incidentRecoveryVerificationRequestSchema", "incidentDetailSchema"),

  operation("GET", "/api/v2/admin/jobs", allOf("generation.job.read"), "generationJobQuerySchema", "generationJobListResponseSchema"),
  operation("GET", "/api/v2/admin/jobs/:id", allOf("generation.job.read"), "path:id", "generationJobDetailSchema"),
  ...
  operation("GET", "/api/v2/admin/reconciliation/invariants", allOf("analytics.metric.read"), "none", "adminCutoverInvariantReportSchema"),

  operation("GET", "/api/v2/admin/saved-views", oneOfBy("saved_view_scope_read", ...collaborationRead), "savedViewListQuerySchema", "savedViewListSchema"),
  operation("POST", "/api/v2/admin/saved-views", oneOfBy("saved_view_scope_read", ...collaborationRead), "savedViewCreateSchema+idempotency-key", "savedViewMutationSchema"),
  operation("PATCH", "/api/v2/admin/saved-views/:id", oneOfBy("saved_view_scope_read", ...collaborationRead), "savedViewUpdateSchema+if-match", "savedViewMutationSchema"),
  operation("DELETE", "/api/v2/admin/saved-views/:id", oneOfBy("saved_view_scope_read", ...collaborationRead), "if-match", "savedViewDeleteSchema"),
  ...
  operation("POST", "/api/v2/admin/today/claim", oneOfBy("today_claim_source_write", ...todayClaimWrite), "todayClaimRequestSchema", "todayClaimResponseSchema"),
