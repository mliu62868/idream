...
export const adminZhGrowth: Record<string, string> = {
  ...
  "Reload queue": "重新加载队列",
  "Loading Comics…": "正在加载漫画…",
  "No Comics in this queue.": "此队列暂无漫画。",
  "{count} pages": "{count} 页",
  "Review pages": "审阅页面",
  "Load more Comics": "加载更多漫画",
  "Unavailable page": "页面不可用",
  "Decision reason": "决定理由",
  "Approve version": "批准版本",
  "Reject version": "驳回版本",
  "Remove published version": "撤下已发布版本",
  "Current status:": "当前状态：",
  "Dreamcoin offers": "梦币充值商品",
  "Create a draft with approved commercial terms. Publishing replaces the previous live version of the same offer.": "使用已批准的商业条款创建草稿。发布后，同一商品的上一生效版本将下线。",
  "Loading coin offers…": "正在加载充值商品…",
  "No coin offers have been configured.": "尚未配置梦币充值商品。",
  "Create coin offer draft": "创建充值商品草稿",
  "Offer key": "商品标识",
  "Offer name": "商品名称",
  "Dreamcoin amount": "梦币数量",
  "Price in cents": "售价（分）",
  "Currency": "定价币种",
  "Buyer eligibility": "购买资格",
  "All signed-in accounts": "所有已登录账号",
  "Active paid access only": "仅限付费访问有效的账号",
  "Customer purchase and refund terms": "用户购买及退款条款",
  "Complete the offer fields, including the customer purchase and refund terms.": "请填写完整的商品信息，包括面向用户的购买及退款条款。",
  "Saving…": "正在保存…",
  "Save coin offer draft": "保存充值商品草稿",
  "Publish coin offer": "发布充值商品",
  "Retire coin offer": "下线充值商品",
  "Purchase terms": "购买条款",
  "New purchases use this version. Previously accepted invoices keep their original price, coin amount, and terms.": "新购买使用此版本。此前已接受的发票保持原售价、梦币数量和条款。",
  "New purchases stop. Previously accepted invoices remain payable under their original terms.": "停止接受新购买。此前已接受的发票仍按原条款支付。",
