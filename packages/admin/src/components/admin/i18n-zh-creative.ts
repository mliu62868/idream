...
export const adminZhCreative: Record<string, string> = {
  ...
  "Retry in progress": "正在重试",
  "Retry {count} again": "再次重试 {count} 个失败项",
  "Retry {count} eligible failed": "恢复 {count} 个符合条件的失败项",
  "Resume retry submission": "恢复重试提交",
  "Submitting retry…": "正在提交重试…",
  "Return to the latest unfinished batch without starting over.": "返回最近未完成的图片批次，无需重新开始。",
  "Review against the brief": "对照创意简报审核",
  "Candidate reviewed": "候选项已审核",
  "Review complete": "审核完成",
  "Review required": "需要审核",
  "This Run is still awaiting a review decision. Nothing is ready for downstream handoff yet.":
    "该批次仍在等待审核决定，当前没有可交给下游的内容。",
  "not retryable": "不可自动重试",
  "reviewed": "已审核",
