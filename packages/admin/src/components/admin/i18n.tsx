...
const zh: Record<string, string> = {
  ...
  "Pocket TTS voice cloning is ready.": "Pocket TTS 声音克隆已就绪。",
  "Pocket TTS speech is running, but clone weights require model access. Accept the kyutai/pocket-tts model terms, provide HF_TOKEN, and restart the Pocket TTS process.": "Pocket TTS 语音合成已运行，但克隆权重需要模型访问权限。请接受 kyutai/pocket-tts 模型条款，提供 HF_TOKEN，然后重启 Pocket TTS 进程。",
  "Pocket TTS is configured but unreachable. Start or restart the Pocket TTS process.": "Pocket TTS 已配置但当前无法连接。请启动或重启 Pocket TTS 进程。",
