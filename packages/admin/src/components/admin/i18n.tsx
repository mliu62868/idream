...
const zh: Record<string, string> = {
  ...
  "Clone and activate voice": "克隆并启用声音",
  "The existing voice clone result was recovered.": "已恢复现有的声音克隆结果。",
  "The cloned voice is now active for new chat speech.": "克隆声音现已用于新的聊天语音。",
