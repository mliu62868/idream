...
const zh: Record<string, string> = {
  ...
  "clone ready": "可克隆",
  "model access required": "需要模型访问权限",
  "clone service unavailable": "克隆服务不可用",
  "clone provider inactive": "克隆供应器未启用",
  "Pocket TTS MLX voice cloning is ready.": "Pocket TTS MLX 声音克隆已就绪。",
  "Pocket TTS MLX speech is running, but clone weights require model access. Accept the kyutai/pocket-tts model terms, provide HF_TOKEN, and restart the Pocket TTS process.": "Pocket TTS MLX 语音合成已运行，但克隆权重需要模型访问权限。请接受 kyutai/pocket-tts 模型条款，提供 HF_TOKEN，然后重启 Pocket TTS 进程。",
  "Pocket TTS MLX is configured but unreachable. Start or restart the Pocket TTS process.": "Pocket TTS MLX 已配置但当前无法连接。请启动或重启 Pocket TTS 进程。",
  ...
  "Use a clean single-speaker recording. Pocket TTS MLX uses up to the first 30 seconds.": "请使用干净的单人录音；Pocket TTS MLX 最多使用前 30 秒。",
