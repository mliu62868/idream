...
export const adminZhCharacters: Record<string, string> = {
  ...
  "Face traits (one per line)": "脸部特征（每行一个）",
  "First message (optional)": "开场白（选填）",
  "For example: make her look more mature, with long hair and more refined makeup.":
    "例如：让她看起来更成熟一些，换成长发，妆容更精致。",
  Generate: "生成",
  "Generate 1 candidate image": "生成 1 张候选图",
  "Generated images are saved here": "生成后的图片会保存在这里",
  "Generating…": "正在生成…",
  ...
  "Identity constraint": "身份约束",
  "Identity description": "身份描述",
  "Identity reference": "身份参考图",
  "Image must be 15 MB or smaller": "图片不能超过 15 MB",
  "Image to image": "图生图",
  "In progress": "进行中",
  "In use": "当前使用",
  ...
  "Loading tags": "正在加载标签",
  "Local image upload failed": "本地图片上传失败",
  "Local image uploaded and set as this run's source. The official reference set is unchanged.":
    "本地图片已上传并设为本轮来源；正式参考集未改变。",
  "Locked seed": "锁定种子",
  "Negative prompt: {value}": "负向提示词：{value}",
  "No current look yet": "还没有当前形象",
  "No reference images available yet": "还没有可用参考图",
  "No tags exist yet. Create them in Taxonomy first.":
    "还没有任何标签，请先到「分类法」里创建。",
  "Not activated yet": "尚未激活",
  "Not started": "未开始",
  ...
  Randomize: "随机",
  "Read only · content.tag.write is not granted":
    "只读 · 未授予 content.tag.write",
  ...
  Sensitive: "敏感",
  "Serving {action} failed": "服务{action}操作失败",
  "Set as current look": "设为当前形象",
  "Showing {count} characters": "本页 {count} 个角色",
  "Showing {count} characters · more on the next page":
    "本页 {count} 个角色 · 下一页还有",
  ...
  "This response does not include a visual identity experiment route yet.":
    "当前响应尚未提供视觉身份实验线路。",
  "This run has no prompt snapshot": "本轮没有提示词快照",
  ...
  Fears: "恐惧",
  "First token {first}ms · total {total}ms · {temperature}":
    "首 token {first} 毫秒 · 总计 {total} 毫秒 · {temperature}",
  ...
  Validate: "校验",
  Values: "价值观",
  "Variation strength: {value}": "变化强度：{value}",
  "View candidate {number} from run {run}":
    "查看第 {run} 次创作的候选图 {number}",
  "View prompts": "查看提示词",
  "Visual experiment history could not be loaded": "无法读取视觉实验历史",
  "Visual identity experiment could not be created": "无法创建视觉身份实验",
  Vocabulary: "词汇偏好",
  "Voice avoids": "表达禁区",
  "Voice habits": "表达习惯",
  "Voice tone": "语气",
  Wants: "渴望",
  "What should {name} look like?": "想让 {name} 变成什么样？",
  affection: "亲密表达",
  cold: "冷启动",
  conflict: "冲突处理",
  curiosity: "好奇方式",
  ...
  tokens: "词元",
  warm: "已预热",
  ". Ask an administrator for the matching scoped permission.":
    "。请联系管理员授予对应范围的权限。",
  ...
  "A dependable evening ritual that helps them decompress":
    "帮助他们放松下来的可靠晚间仪式",
  "A precise, warm place to put the day down":
    "一个准确、温暖、让人卸下一天疲惫的空间",
  "A reusable visual identity has not been established.":
    "尚未建立可复用的视觉身份。",
  ...
  "Chat moments": "聊天场景图",
  Chats: "聊天数",
  "Check the customer-facing draft before publishing.":
    "发布前检查用户将看到的角色草稿。",
  ...
  Clean: "无举报",
  "Clear filters to return to all characters.":
    "清除筛选条件即可返回全部角色。",
  ...
  "Complete the image pack the live character is missing":
    "补齐线上角色缺失的图片资产",
  "Complete the portrait, hero, and chat image set.":
    "继续补齐主肖像、角色主视觉和聊天场景图。",
  ...
  "Manage Character settings, assets, and live operations":
    "管理角色设定、素材与线上运营",
  "Character settings": "设定",
  "Character assets": "素材",
  "Character operations": "运营",
  "Character workspace area": "角色工作区",
  ...
  "Describe motion, identity stability, artifacts, and intent match":
    "描述动作、身份稳定性、画面瑕疵以及与意图的匹配度",
  ...
  "Publish the current Character to create the first release.": "发布当前角色即可创建首个版本。",
  "Complete the release requirements shown here before creating the first release.":
    "请先完成此页列出的发布要求，再创建首个版本。",
  ...
  "Identity v": "身份版本 v",
  "Identity, references, and route are protected for this image.":
    "这张图已锁定角色身份、参考集和生成线路。",
  ...
  "No active immutable Visual Identity version exists.":
    "当前没有生效的不可变视觉身份版本。",
  ...
  "No evaluation evidence for the active identity style.":
    "当前生效身份风格没有评估证据。",
  ...
  "No runs": "暂无批次",
  "No operation evidence exists for this Character.":
    "该角色暂无媒体生产记录。",
  ...
  "Not published": "未发布",
  "Not run": "未执行",
  "Observant, measured, gently challenging":
    "善于观察、沉着克制、温和地提出挑战",
  ...
  "One source image becomes one reviewable four-second clip.":
    "一张源图片将生成一个可审核的 4 秒视频。",
  ...
  "Open Studio": "打开工作室",
  "Open Visual Identity to resolve the existing authority blockers.":
    "打开视觉身份工作区，解决现有权威阻塞项。",
  ...
  "Read-only: character.release.publish is not granted.":
    "只读：尚未授予 character.release.publish。",
  "Read-only: character.release.publish is required to activate a voice.":
    "只读：启用声音需要 character.release.publish 权限。",
  "Read-only: content.official.write is not granted.":
    "只读：尚未授予 content.official.write。",
  ...
  "Return to the latest unfinished image without starting over.":
    "返回最近未完成的图片，无需重新开始。",
  ...
  "Preview Character": "预览角色",
  "Preview the customer-facing draft before publishing.":
    "发布前预览用户看到的角色草稿。",
  ...
  "Rollback and live operations": "回滚与线上操作",
  ...
  "Speaking pace": "说话速度",
  "Speaking style": "说话风格",
  "Specific evening rituals improve qualified conversations":
    "具体的晚间仪式可提升高质量对话",
  ...
  "The existing voice candidate result was recovered.":
    "已恢复现有的候选声音结果。",
  "The experiences that shaped this character's point of view":
    "塑造该角色观点的经历",
  ...
  "The generation run still succeeded — this is a playback problem.":
    "生成批次本身是成功的 —— 这是播放环节的问题。",
  ...
  "The selected image pack contains a missing or unavailable exact asset.":
    "所选图片包包含缺失或不可用的准确图片资产。",
  "The selected image pack was generated under an older route.":
    "所选图片包由旧版路线生成。",
  "The selected video Run does not belong to this Character.":
    "所选视频生产批次不属于当前角色。",
  "The system voice preview could not be rendered": "无法生成系统声音试听",
  "The video could not be played.": "该视频无法播放。",
  "The video did not start playing in this browser.":
    "这个浏览器没能开始播放该视频。",
  "The video download failed. Check network access to the asset URL.":
  ...
  "Type the projected Voice reclaim confirmation":
    "输入投影中的语音回收确认文本",
  ...
  "Wardrobe, palette, lighting, camera language, recurring settings…":
    "服装、色板、光线、镜头语言、常用场景…",
  ...
  "creative brief": "创意简报",
  "creative.run.read is required to see character production.":
    "查看角色图片生产需要 creative.run.read 权限。",
  ...
  "{count} characters need an operator next step":
    "有 {count} 个角色等待运营处理",
  ...
  "{count} to resolve": "{count} 项待处理",
  "{count} monitoring windows": "{count} 个观测窗口",
  ...
  "Character profile and status": "角色资料与状态",
  "Automated preflight": "自动发布校验",
  "Complete the current image pack before publishing.":
    "请先补齐当前图片资产包再发布。",
  "Draft matches live": "草稿与线上一致",
  "Inspect live monitoring": "检查线上监控",
  "Live and draft are identical": "线上版本与草稿一致",
  "Live release blocked": "线上版本存在阻塞",
  "Live and draft are identical. There is nothing to release.":
    "线上版本与草稿一致，没有内容需要发布。",
  "No telemetry after 7 days": "上线 7 天后仍无观测数据",
  "No live Character is missing a required image placement.":
    "没有线上角色缺少必需的图片铺位。",
  "No unpublished changes": "没有未发布更改",
  Saved: "已保存",
  "The system verifies the exact content, images, generation route, and conversation profiles when you continue.":
    "继续后，系统会自动校验准确的内容、图片、生成路线和对话配置。",
  "All images for {name}": "{name} 的全部图片",
  "All videos for {name}": "{name} 的全部视频",
  "Character images could not be loaded": "无法加载角色图片",
  "Character video library": "角色视频素材库",
  "Character cards and primary portrait": "角色卡片与主肖像",
  "Character detail hero image": "角色详情页主视觉",
  "Conversation scene image": "聊天场景图片",
  Conflict: "存在冲突",
  Current: "当前使用",
  "Choose {placement} image": "选择{placement}图片",
  "Choose image": "选择图片",
  "Choose where existing images appear": "选择现有图片的展示位置",
  "Close creator": "关闭创作器",
  Cover: "封面",
  "Create or import the first image for this Character.":
    "为这个角色创作或导入第一张图片。",
  "Create or import the first video for this Character.":
    "为这个角色创作或导入第一个视频。",
  ...
  "Image imported to this Character's library": "图片已导入该角色的素材库",
  "Image imported as a Review candidate": "图片已导入，等待审核",
  "Review approved. This image is now selectable.": "审核已通过，现在可以选择这张图片用于展示。",
  "Review rejected. This image remains in the library but cannot be selected.":
    "审核未通过。图片会保留在素材库中，暂时不能用于展示。",
  "Image Review failed": "图片审核失败",
  "Review imported Character image": "审核导入的角色图片",
  "Qualify imported image": "确认导入图片可用于展示",
  "This decision is pinned to the current sealed Visual Identity. Initial identity sources belong in Identity Lab; this path qualifies final Cover, Hero, and Chat candidates.":
    "本次审核以角色当前已封存的视觉身份为准，用于确认封面、主视觉和聊天候选图。初始身份参考图请在身份实验室中设置。",
  "Close Review": "关闭审核",
  "Identity matches the current sealed Character": "与角色当前已封存的视觉身份一致",
  "Visible Review reason": "审核说明",
  "Approve for placement": "通过审核，允许用于展示",
  "Reject candidate": "拒绝候选图片",
  "Needs attention: {reasons}": "待处理：{reasons}",
  "Review image candidate": "审核候选图片",
  "Review again": "重新审核",
  "Update Review authority": "更新采用的审核记录",
  selectable: "可选择",
  "release qualified": "符合发布要求",
  "asset unavailable": "素材不可用",
  "source authority invalid": "素材来源记录无效",
  "purpose mismatch": "图片用途不匹配",
  "review pending": "等待审核",
  "review rejected": "审核未通过",
  "review authority changed": "审核记录已变更",
  ...
  "Import video": "导入视频",
  Imported: "已导入",
  "In memory only": "仅保存在当前页面",
  "No image library permission": "没有素材库权限",
  "No video library permission": "没有视频素材库权限",
  "No images are available. Create or import images in Images first.":
    "暂无可用图片，请先在“图片”中创作或导入。",
  "No reviewed images are selectable for this placement. Review an imported candidate or approve a matching generated image in Images first.":
    "此展示位暂无已通过审核的可选图片。请先在“图片”中审核导入的候选图，或通过用途匹配的生成图片。",
  "No images yet": "还没有图片",
  "No videos yet": "还没有视频",
  "No matching images": "没有匹配的图片",
  "No matching videos": "没有匹配的视频",
  "Clear search": "清除搜索",
  "Error details": "错误详情",
  "Showing previously loaded items.": "当前显示的是上次加载的素材。",
  "Not saved": "未保存",
  "Failed to save": "保存失败",
  "Removal reason": "移出原因",
  "Remove from library": "移出素材库",
  "Remove image from library": "从素材库移出图片",
  "Remove image from library?": "要从素材库移出这张图片吗？",
  ...
  "Search images": "搜索图片",
  "Search videos": "搜索视频",
  "Set as identity": "设为角色身份",
  "The image will be archived and hidden from this Character's library.":
    "图片将被归档，并从该角色的素材库中隐藏。",
  ...
  "Video imported to this Character's library": "视频已导入该角色的素材库",
  "Video must be 100 MB or smaller": "视频大小不能超过 100 MB",
  "Video ready": "视频已生成",
  "Video removed from the library": "视频已移出素材库",
  "Videos used by an active campaign or release must be replaced first.":
    "正在活动营销或发布中使用的视频必须先替换。",
  "Choose an MP4 or WebM video": "请选择 MP4 或 WebM 视频",
  "Replace this video where it is in use before removing it.":
    "请先在使用位置替换这个视频，再将其移出。",
  "This choice defines the face used for future image creation. You can create more candidates before choosing.":
    "这个选择会定义后续图片创作使用的角色面孔；你也可以先创作更多候选图。",
  "Use image": "使用图片",
  "Use image for {placement}": "将图片用于{placement}",
  "Use this image as the Character identity?": "将这张图片设为角色身份吗？",
  "Used in another placement": "已用于其他展示位",
  "{name} {placement}": "{name} 的{placement}",
  ...
  "This live Character has no exposure or funnel events after the 7-day observation window.":
    "该线上角色在 7 天观测窗口结束后仍没有曝光或漏斗事件。",
  "{count} unpublished changes": "{count} 项未发布更改",
  "· Asset pack": "· 图片资产包",
  "· ContentVersion": "· 内容版本",
  "· Reference r": "· 参考集 r",
  "· Serving v": "· 上线服务 v",
  "· reference": "· 参考图",
  "· release v": "· 发布版本 v",
  "Could not publish Character": "无法发布角色",
  "Publish Character": "发布角色",
  "Publish current Character": "发布当前角色",
  "Roll back": "回滚",
