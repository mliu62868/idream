...
export const adminZhCharacters: Record<string, string> = {
  ...
  "Could not propose Release": "无法提交发布提案",
  "Could not review Release": "无法完成发布审核",
  "Could not validate Release": "无法校验发布",
  ...
  "View candidate {number} from run {run}": "查看第 {run} 次创作的候选图 {number}",
  "View prompts": "查看提示词",
