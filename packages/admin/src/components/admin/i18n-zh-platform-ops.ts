...
// 后果型文案（`ConfirmDialog.consequence` 落地后从 summary 平移过去）与截断如实标注
  ...
  "Downstream numbers built on these tables are safe for decisions.": "在这些表之上算出来的数字可以用于决策。",
  ...
  "Open the missing Case from the sampled source, then re-check": "为样本来源补开工单，然后重新检查",
