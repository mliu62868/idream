...
export const adminZhShell: Record<string, string> = {
  ...
  "Customers & Support": "用户与客服",
  "Revenue & Marketing": "收入与营销",
  "Orders & Billing": "订单与账务",
  "Site Content & SEO": "站点内容与 SEO",
  "History & specialist tools": "历史与专项工具",
  ...
  "Growth analyst": "增长分析",
  "Handoff": "交接",
  "Jump to a page or search records…": "跳转到页面，或搜索记录…",
