...
export const fieldClass =
  "h-11 w-full min-w-0 rounded-md border border-[var(--ad-border)] bg-[var(--ad-surface)] px-3 text-sm text-[var(--ad-ink)] outline-none transition-colors disabled:cursor-not-allowed disabled:bg-[var(--ad-surface-subtle)] focus:border-[var(--ad-ink)] focus:ring-2 focus:ring-[var(--ad-ink)]/10";
...
export function WorkspaceButton({
  ...
  return (
    <button
      className={cn(
        "inline-flex min-h-11 items-center justify-center gap-2 rounded-md border px-3 text-sm font-semibold transition-[background-color,transform] duration-150 enabled:active:translate-y-px disabled:cursor-not-allowed disabled:border-[#c9c7c0] disabled:bg-[#e7e5df] disabled:text-[#5d5f59]",
