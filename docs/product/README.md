...
| 如何通过 Chrome 全面体检主站？ | [主站产品体检清单](MAIN_SITE_HEALTH_CHECKLIST.md) | 逐页功能、完整旅程、故障恢复与证据要求；执行结果另存，不代表当前已通过 |
...
| 怎样在 Chrome 完整体检 Admin？ | [Admin 产品与运营体检清单](ADMIN_PRODUCT_HEALTH_CHECKLIST.md) | 功能、入口、正常/异常流程、权限与证据要求；不代表已经验收通过 |
