---
name: clone-website
description: Rebuild a live website or page from its observed layout, assets, and interactions. Use when the user requests a visual clone of one or more URLs, not for product-parity analysis alone.
