...
// Native backends report structured usage, including one provider request ID per
// output. Finalize must preserve that evidence from the durable terminal record.
const usageSchema = z.record(z.string(), z.json());
